                        ...
                        <div class="tour-infomation__content">
                            <div class="tour-infomation__content__header">
                                ...
                                <div class="tour-infomation__content__header__icon">                                    
                                    ...
                                    <p><i class="fas fa-door-closed"></i>&nbsp;&nbsp;
                                    {{ $wajba->door_type == 'in_door' ? __('messages.Indoor') : __('messages.Outdoor')}}</p>
                                    @if ($wajba->time != null)
                            ...
                            {{-- <div class="tour-infomation__content__descript">
                                <h2> @lang('messages.Healthy_Condition_And_Warning')</h2>
                            ...
                            <div class="right-sidebar__item">
                                <div class="text-center per_price">
                                    <p class="text-center">Estimated</p>
                                         <h3><span class="mr-2">SR</span>{{$wajba->price + 20/100 * $wajba->price}}</h3>
                                   
                                          
                                        <p class="text-center">Cost of service fee of 20% is added to the total</p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">        
                ...
                <div class="modal-body" style="padding: 2rem;">
                    <p class="male_number">@lang('messages.Number_of_males?'): <span></span></p>
                    <p class="female_number">@lang('messages.Number_of_females'): <span></span></p>
                    <p class="children_number">@lang('messages.Number_of_childrens'): <span></span></p>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <span class="custom-invalid-feedback display_none" id="not_mobile" role="alert">
                        <strong>The mobile number is registered.</strong>
                    </span>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">        
                <div class="modal-body">
                    ...
                    <div class="form-group wajba-control">
                        <input type="text" class="form-control" name="lastName" id="last_name" placeholder="Enter your @lang('messages.Last_Name')" required>
