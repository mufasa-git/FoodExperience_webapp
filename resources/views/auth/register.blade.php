    ...
    <div class="d-flex align-items-center justify-content-center bg-gray-200 ht-100v">
        ...
        <div class="overlay-body bg-black-6 d-flex align-items-center justify-content-center ">
            <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base animated zoomIn" id="verify_form">
                ...
                <div class="form-group">
                    <div class="d-md-flex pd-y-20 pd-md-y-0">
                        ...
                        <input type="text" class="form-control" placeholder="Enter your mobile" id="mobile_verify" value="" autofocus>                        
                    </div>
                ...
                <button type="button" class="btn btn-custom btn-block mg-t-10" id="verify" disabled>Verify</button>
                  <button type="button" class="btn btn-custom btn-block mg-t-10" id="skip" enabled>Skip</button>
                  <p> If you do not want to receive the verification code, please click the skip button</p>
            ...
            <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base display_none animated zoomIn" id="confirm_form">
                ...
                <button type="button" class="btn btn-custom btn-block mg-t-10" id="skip" enabled>Skip</button>
                  <p> If you do not receive the verification code, please click the skip button</p>
            ...
            <form action="{{ route('register') }}" method="post" id="user_register_form"  enctype="multipart/form-data">
                ...
                <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base animated zoomIn display_none" id="register_form">
                    ...
                    <div id="for_guest">
                        <div class="form-group">
                            <input type="text" class="form-control" name="firstName" value="{{ old('firstName') }}" placeholder="Enter your @lang('messages.First_Name')" required autofocus>
                                <span class="invalid-feedback" role="alert" id="firstname_error">
                                    <strong>@lang('messages.First_Name') @lang('messages.Required') </strong>
                                </span>
                        </div><!-- form-group -->
                        <div class="form-group">
                            <input type="text" class="form-control" name="lastName" value="{{ old('lastName') }}" placeholder="Enter your @lang('messages.Last_Name')" required>
                                <span class="invalid-feedback" role="alert" id="lastname_error">
                                    <strong>  @lang('messages.Required')</strong>
                                </span>
                        </div><!-- form-group -->
                        <div class="form-group">
                            <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Enter your email" required>
                                <span class="invalid-feedback" role="alert" id="email_require_error">
                                    <strong>@lang('messages.Email') @lang('messages.Required')</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="city" id="city" value="{{ old('city') }}" placeholder="Enter your city" required>
                                <span class="invalid-feedback" role="alert" id="city_error">
                                    <strong>  @lang('messages.City')  @lang('messages.Required')  </strong>
                                </span>
                        </div><!-- form-group -->
                        <div class="form-group">
                    ...
                    <div id="for_host" class="display_none">
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback" role="alert" id="name_id_error">
                                <strong>@lang('messages.Nickname') @lang('messages.Required') </strong>
                            </span>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback" role="alert" id="about_error">
                                <strong>@lang('messages.About_You')   @lang('messages.Required')</strong>
                            </span>
                        </div>
                    </div>
                    {{-- <div class="form-group tx-12">By clicking the Sign Up button below, you agreed to our privacy policy and terms of use of our website.</div> --}}
                    <button type="button" id="sign_submit" class="btn btn-info btn-block">@lang('messages.Sign_Up') </button>
                    <button type="button" id="sign_next" class="btn btn-info btn-block display_none"> @lang('messages.Next')   </button>
                    <button type="button" id="sign_prev" class="btn btn-info btn-block display_none"> @lang('messages.Back')</button>

                    <div class="mg-t-30 tx-center">Already a member? <a href="{{ route('login') }}" class="tx-info"> @lang('messages.Sign_In')</a></div>
                </div><!-- login-wrapper -->
            </form>
        </div>
    </div><!-- d-flex -->
    ...
    <div class="modal" id="term_modal">
        <div class="modal-dialog modal-dialog-scrollable">
            ...
            <div class="modal-header">
                <h1 class="modal-title">@lang('messages.Terms_And_Conditions')    </h1>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-custom" data-dismiss="modal"> @lang('messages.Close')</button>
            </div>
