...
@endphp
    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle">
            ...
            {{-- <p class="mg-b-0">Registed Approved Bookings</p> --}}
        </div>            
    </div><!-- d-flex -->
        ...
        <div class="row row-sm mg-t-20 card card-body">
            <div class="col-md-12">
                <div class="search-form">
                    <form action="{{ route('admin.booking_manage_approve') }}" method="POST" class="form-inline float-left" id="searchForm">
                        @csrf
                ...
                <div class="bd bd-gray-300 rounded table-responsive">
                    <table class="table table-bordered mg-b-0">
                        <thead>
                            ...
                            <th>@lang('messages.Guest_name')</th>
                            <th>Number Of Booked Pepole</th>
                            <th>Status</th>
                            <th>Paid</th>
                            <th>Detail</th>
                        </thead>
                                        ...
                                        <td>
                                            @if ($item->payment_id != null)
                                                @if ($item->payment->status)
                                                    <span class="badge badge-primary pd-y-3 pd-x-10 tx-white tx-11 tx-roboto">Paid</span>
                                                @else
                                                    <span class="badge badge-warning pd-y-3 pd-x-10 tx-white tx-11 tx-roboto">Not Paid</span>
                                                @endif                                                
                                            @else
                                                -
                                            @endif
