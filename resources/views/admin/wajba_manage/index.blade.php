...
@endphp
    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle">
            ...
            {{-- <p class="mg-b-0">Registed All Wajbas</p> --}}
        </div>            
    </div><!-- d-flex -->
        ...
        <div class="row row-sm mg-t-20 card card-body">
            <div class="col-md-12">
                <div class="search-form">
                    <form action="{{ route('admin.wajba_manage') }}" method="POST" class="form-inline float-left" id="searchForm">
                        @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    @if ($item->status_id == 2)
                                        <span class="badge badge-warning pd-y-3 pd-x-10 tx-white tx-11 tx-roboto">{{ $item->status->type }}</span>
                                    @endif
                                    @if ($item->status_id == 3)
