...
@endphp
    ...
    <div class="br-mainpanel">
        <div class="br-pagetitle">
            ...
            <div>
            <h4>Rejected Experience</h4>
            {{-- <p class="mg-b-0">Rejected All Wajbas</p> --}}
        </div>            
    </div><!-- d-flex -->
        ...
        <div class="row row-sm mg-t-20 card card-body">
            <div class="col-md-12">
                <div class="search-form">
                    <form action="{{ route('admin.wajba_manage_reject') }}" method="POST" class="form-inline float-left" id="searchForm">
                        @csrf
