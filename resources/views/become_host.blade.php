        ...
        <div class="row">
            ...
            <div class="col-8 user_content p-4">
                <form action="{{ route('become_host_save') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div>
                        <label for="nameId"> @lang('messages.Nickname')
</label><div class="spinner-border spinner-border-sm text-primary ml-2 display_none" style="margin-bottom: 2px;"></div>&nbsp;&nbsp;&nbsp;<span class="" id="check_complete"></span>
                    ...
                    <div>
                        <label for="">@lang('messages.Photo')</label>
