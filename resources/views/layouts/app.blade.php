            ...
            <div class="header-content2">
                        ...
                        @else
                            ...
                            {{-- <li class="notify" id="">
                                ...
                                <ul class="sub-menu" style="right:0;">
                                    <li>
                                        <span class=""><b>@lang('messages.My_Notifications')
</b></span> 
                            ...
                            <li style="margin-left: 20px;">
                                ...
                                @endif
                                    <ul class="sub-menu" style="right:0;">
                                        <li><a href="{{ route('home') }}"> @lang('messages.Dashboard')</a></li>
                                        <li><a href="javascript:void(0);" class="change_password">@lang('messages.change_password')  </a></li> 
                ...
                <nav class="header-nav-mobile">
                    <ul>
                        ...
                        <li>
                            <a href="{{route('contact_us')}}">@lang('messages.Contact_Us')</a>
                        </li>
                        @guest
                            <li>
                                <a href="{{ route('login') }}"> @lang('messages.Login')</a>
                        ...
                        @else
                            ...
                            <li><a href="javascript:void(0);" class="change_password">  @lang('messages.change_password')</a></li>
                            <li>
                                <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form2').submit();">     @lang('messages.Logout')</a>
                            </li>
            ...
            <div class="modal-content">        
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger display_none" id="alert2" role="alert">
                        ...
                        <div class="d-flex align-items-center justify-content-start">
                            <i class="icon ion-ios-checkmark alert-icon tx-32 mg-t-5 mg-xs-t-0"></i>
                            <span><strong>@lang('messages.Fail')</strong>  @lang('messages.The_old_password_is_incorrect')</span>
                        </div><!-- d-flex -->
                    </div><!-- alert -->
                    <div class="form-group mt-4">
                        <input class="form-control" id="old_password" placeholder="Old Password" type="password" autocomplete="off">
                        <small class="first">  @lang('messages.Please_enter_old_password') </small>
                    </div>
                    <div class="form-group">
                        <input class="form-control" id="new_password" placeholder="New Password" type="password">
                        <small class="second">  @lang('messages.Please_enter_new_password')   </small>
                        <small class="third">  @lang('messages.Passwords_must_be_match_the_confirmation')   </small>
                    </div>
                    <div class="form-group">
                        <input class="form-control" id="confirm_password" placeholder="Confirm Password" type="password">
                    </div>
                    <div class="form-group">
                        <button type="button" class="btn btn-custom btn-block" id="password_save">  @lang('messages.Save')  </button>
                        <button type="button" id="password_close" class="btn btn-secondary btn-block" data-dismiss="modal"> @lang('messages.Close')</button>
                    </div>                    
                </div>
            </div>
        </div>
