    ...
    <div class="wand-container">
        <div class="header-content1">
            ...
            <nav class="header-1-nav">
                <ul>
                    <li>
                        <a href="{{route('welcome')}}">@lang('messages.Home')</a>
                    </li>

                    <li>
                        <a href="{{route('about_us')}}">@lang('messages.About_Us')  </a>
                    </li>
                    ...
                    @else
                        ...
                        @if (auth()->user()->role->type == 'guest')
                            <li>
                                <a href="{{ route('become_host') }}">  @lang('messages.become_a_host')  </a>
                            </li>
                        @endif
                        {{-- <li class="notify">
                            ...
                            <ul class="sub-menu" style="right:0;">
                                <li>
                                    <span class=""><b> @lang('messages.Notifications')</b></span>
                                    <span class="mark_all"> @lang('messages.Mark_All_As_Read') </span>
                                </li>
                        ...
                        @if (auth()->user()->photo)
                            <li>
                                ...
                                <ul class="sub-menu" style="right:0;">
                                    ...
                                    <li><a href="javascript:void(0);" id="change_password">@lang('messages.change_password')</a></li>
            ...
            <nav class="header-nav-mobile">
                <ul>
                    <li>
                        <a href="{{ asset('welcome') }}">@lang('messages.Home')</a>
                    </li>
                    <li>
                        <a href="{{route('about_us')}}">   @lang('messages.About_Us') </a>
                    </li>
                    ...
                    @else
                        ...
                        @endif
                        <li>
                            <a href="{{ route('home') }}"> @lang('messages.Dashboard') </a>
                        </li>
                        <li><a href="javascript:void(0);" id="change_password">  @lang('messages.change_password')  </a></li>
                        <li>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form3').submit();">  @lang('messages.Logout') </a>
                        </li>
        ...
        <div class="header-tittle1">
            ...
            <h1 style="color: #fff;text-transform: uppercase;" class="mb-5">  @lang('messages.Eat_with_Saudis_in_their_homes') </h1>
            <a href="{{route('about_us')}}" class="text-center read_more"> @lang('messages.Read_More')  </a>
        </div>
    </div>
</header>
    ...
    <div class="container">
        ...
        <!-- section tittle -->
            <div class="section-tittle">
                ...
                <p> <span>@lang('messages.Home_experiences') </span></p>
            </div>
        </div>
        <div class="row">
            ...
            @empty
            <div class="col-12">
                <h3>@lang('messages.Coming_soon')</h3>
            </div>
            @endforelse
            ...
            <div class="col-md-12">
                <div class="clearfix mt-2">
                    <div class="float-left" style="margin: 0;">
                        <p>Total <strong style="color: #a7662f">{{ $wajba->total() }}</strong> @lang('messages.Entries')</p>
                    </div>
                    ...
                    <div class="guests">
                        <p> Are you an institution and want us to arrange similar experiences for your guests? </p>
                         <button type="button" class="btn btn-custom ">
                            <a href="{{ route('more_info') }}" style="color:white"> Read more</a>
                        </button>
                    </div>
            </div>
        </div>
                ...
                <div class="footer-widget-1">
                    <div class="footer-widget-1__lists">
                        ...
                        <div class="footer-widget-1__list">
                            ...
                            <ul>
                                <li><a href="{{route('welcome')}}">  @lang('messages.Home')</a></li>
                        ...
                        <div class="footer-widget-1__list">
                            ...
                            <ul>
                                ...
                                {{-- <li><a href="#">@lang('messages.Contact_Information') </a></li> --}}
                            </ul>
                        </div>
                    </div>
                </div>
