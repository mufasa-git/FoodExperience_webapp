        ...
        <div class="row">
            ...
            <div class="col-md-8 col-12 user_content p-4">                
                ...
                <div class="row booking_detail">
                    ...
                    <div class="col-md-6 col-12 mt-4">
                        <p>@lang('messages.Guest_name'): <span>{{ $booking->user->full_name }}</span></p>
                        <p>@lang('messages.Guest_email')  : <span>{{ $booking->user->email }}</span></p>
                        <p>@lang('messages.Guest_gender'): <span>{{ $booking->user->gender }}</span></p>
