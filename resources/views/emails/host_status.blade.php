    ...
    <center>
        <table class="" border="0" cellspacing="0" cellpadding="0" width="600"
            ...
            <tbody>
                ...
                @if ($status_id == 1)
                    <tr>
                        <td style="text-align:center; font-size: 24px;"> @lang('messages.Hello') {{$host_name}},  @lang('messages.Congratulations')     @lang('messages.You_Are_just_approved')     @lang('messages.Host') .</td>
                    </tr>                    
                @endif
                @if ($status_id == 0)
                    <tr>
